...
ImageTest.prototype.clearExcludeRegions = function (cb, results) {
  ...
  var rectangleData = ld.map(this.target.excludeRegions, function (reg) {
  ...
  async.each([this.baselinePath, this.samplePath], function (filePath, callback) {
    var command = ['convert', filePath, '-strokewidth 0',
                   '-fill "rgb(255,0,255)"', rectangleData, filePath];
